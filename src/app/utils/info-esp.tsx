...
/*
*
* websiteProps: Propiedades del sitio web
*   websiteNameFull: Nombre para la pestaña del navegador
*   websiteDescription: Descripción del sitio web (Etiqueta meta description)
*   websiteKeywords: Palabras clave para SEO
*
* titleContent: Información para el encabezado superior
...
* 
* topCtaBtnText: Texto del botón del encabezado superior
* 
* servicesSection: Texto de la sección de servicios
...
* 
* footerSection: Propiedades del pie de página
